...
import ch.tkuhn.nanopub.server.shared.io.ipfs.multibase.binary.*;

import java.util.Base64;
import java.util.Map;
import java.util.TreeMap;

import static ch.tkuhn.nanopub.server.shared.io.ipfs.multibase.binary.Base64.encodeBase64;
...
public class Multibase {
    ...
    public static String encode(Base b, byte[] data) {
        switch (b) {
            ...
            case Base64:
                return b.prefix + encodeBase64String(data).replaceAll("=", "");
            case Base64Pad:
                return b.prefix + encodeBase64String(data);
            default:
