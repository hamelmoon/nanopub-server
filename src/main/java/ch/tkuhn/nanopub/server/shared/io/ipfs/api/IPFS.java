...
import ch.tkuhn.nanopub.server.shared.peergos.shared.util.Version;
...
public class IPFS {
    ...
    public class Dag {
        ...
        public byte[] get(Cid cid, String path) throws IOException {
            return retrieve("dag/get?stream-channels=true&output-codec=dag-json&arg=" + cid + path);
        }

        public MerkleNode put(byte[] object) throws IOException {
            return put("dag-cbor", object, "dag-json");
        }

        public MerkleNode put(String inputFormat, byte[] object) throws IOException {
            return put(inputFormat, object, "dag-json");
        }

        public MerkleNode put(byte[] object, String outputFormat) throws IOException {
            return put("dag-cbor", object, outputFormat);
        }
        ...
        public MerkleNode put(String inputFormat, byte[] object, String outputFormat) throws IOException {
            ...
            Multipart m = new Multipart(prefix + "dag/put/?stream-channels=true&hash=sha2-256&input-codec=" + inputFormat + "&store-codec=" + outputFormat, "UTF-8");
