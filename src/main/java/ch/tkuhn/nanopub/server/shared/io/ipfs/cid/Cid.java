package ch.tkuhn.nanopub.server.shared.io.ipfs.cid;

import ch.tkuhn.nanopub.server.shared.io.ipfs.multibase.*;
...
//        if (!super.equals(o)) return false;
    ...
    public static Cid decodePeerId(String peerId) {
        if (peerId.startsWith("1")) {
            ...
            return new Cid(1, Codec.LibP2pKey, hash.type, hash.getHash());
        }
